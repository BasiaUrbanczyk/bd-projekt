...
?>
    ...
    <div class="box">
        <h1 class="h1-text">Dane dodawanego magazynowania: </h1>
    ...
    <?php
        if(isset($_SESSION['terminZajetyMag'])) {
            echo $_SESSION['terminZajetyMag'];
            unset($_SESSION['terminZajetyMag']);}
        else if(isset($_SESSION['dodanoMagazynowanie'])){
            echo $_SESSION['dodanoMagazynowanie'];
            unset($_SESSION['dodanoMagazynowanie']);
        }
        else if(isset($_SESSION['zleDaneMag'])){
            echo $_SESSION['zleDaneMag'];
            unset($_SESSION['zleDaneMag']);
        }
        ?>
